...
map_of_level = imread('C:\Users\10169\OneDrive - International Campus, Zhejiang University\Desktop\louvre\-2_modi.jpg');
map_of_level = double(rgb2gray(map_of_level));
available_index = map_of_level<50;
null_index = map_of_level>200;
map_of_level(available_index)  = 0;
map_of_level(null_index) = 250;
map_of_level(map_of_level<150 & map_of_level>90) = 150;
...
while iterate_times <= max_iterate_times
    ...
    generate_figure_contain_heat(people_position,field_of_louvre,gate_index_matrix,...
    ...
    [field_of_louvre,gate_index_matrix] = generate_fitness_matrix(people_position,gate_position,map_size,radius,alpha,map_of_level);
